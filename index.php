...
<main class="flex-grow">
    ...
    >
        ...
        <div class="pb-12 pt-12 lg:pt-32 px-6 w-full mx-auto text-gray-800 transition ease-in-out delay-200 duration-300">
            <img src="src/signup.svg" class="hidden lg:block w-full max-w-sm mx-auto" alt="auth">
        ...
        <!-- auth -->
        <div class="pb-12 pt-12 lg:pt-32 px-6 w-full mx-auto text-gray-800 transition ease-in-out delay-200 duration-300">
            <img src="src/signin.svg" class="hidden lg:block w-full max-w-sm mx-auto" alt="login">
